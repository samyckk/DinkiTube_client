...
const VideoPage = () => {
    ...
    useEffect(() => {
        const fetchdata = async () => {
            await axios.put(`https://dinki-tube-server.vercel.app/api/videos/addView/${videoId}`).then(() => {
    ...
    const handleLike = async () => {
        ...
        if (!userDetails.likedVids?.includes(videoDetails._id)) {
            await axios.put(`https://dinki-tube-server.vercel.app/api/videos/like/${videoDetails._id}`).then(() => {
    ...
    const handleDislike = async () => {
        ...
        if (!userDetails.dislikedVids?.includes(videoDetails._id)) {
            await axios.put(`https://dinki-tube-server.vercel.app/api/videos/dislike/${videoDetails._id}`).then(() => {
    ...
    const handleDelete = async () => {
        ...
        if (channel._id === userDetails._id) {
            await axios.delete(`https://dinki-tube-server.vercel.app/api/videos/${videoDetails._id}`).then(() => {
