...
const SignInUpForm = ({setIsLogin}) => {
    ...
    const handleLogin = async (e) => {
        ...
        dispatch(loginStart());
        try {
            const res = await axios.post("http://localhost:8000/api/auth/signin", { name, password }, { withCredentials: true });
    ...
    const handleSignup = async () => {
        ...
        try {
            await axios.post("http://localhost:8000/api/auth/signup", { name, email, password }, { withCredentials: true });
