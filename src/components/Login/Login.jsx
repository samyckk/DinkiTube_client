...
const SignInUpForm = ({setIsLogin}) => {
    ...
    const signinwithgoogle = async () => {
        try {
            ...
            dispatch(loginStart());
            const res = await axios.post("https://dinki-tube-server.vercel.app/api/auth/google", {
    ...
    const handleLogin = async (e) => {
        ...
        dispatch(loginStart());
        try {
            const res = await axios.post("https://dinki-tube-server.vercel.app/api/auth/signin", { name, password }, { withCredentials: true });
    ...
    const handleSignup = async () => {
        ...
        try {
            await axios.post("https://dinki-tube-server.vercel.app/api/auth/signup", { name, email, password }, { withCredentials: true });
